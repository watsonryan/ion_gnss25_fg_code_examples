...
if __name__ == "__main__":
    factor_graph, initial_estimate = run_simulations_for_multiple_epochs(
        ...
        plot_cdf_output_path='plots/ex_3_position_error_cdf.png',
        plot_trajectory_output_path='plots/ex_3_trajectory_and_errors.png',
        print_results=True
    )
    visualize_factor_graph(factor_graph, initial_estimate, "plots/ex_3_factor_graph")
